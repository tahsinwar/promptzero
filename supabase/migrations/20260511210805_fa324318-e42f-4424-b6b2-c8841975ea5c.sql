-- Recreate get_home_stats with SECURITY INVOKER (only reads public is_published data)
...
-- Recreate get_prompt_detail with SECURITY INVOKER (all referenced tables have public read RLS)
...
REVOKE ALL ON FUNCTION public.get_prompt_detail(text) FROM PUBLIC;
